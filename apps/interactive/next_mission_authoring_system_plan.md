...
Этот этап нужен, чтобы `apps/interactive` мог расти быстрее, но не превращался
...
- `apps/interactive/mission_authoring_guide.md`.
...
- `apps/interactive/mission_quality_checklist.md`;
...
- `apps/interactive/accessibility_baseline.md`;
...
- `apps/interactive/performance_budget.md`.
...
- `apps/interactive/deploy_link_policy.md`.
