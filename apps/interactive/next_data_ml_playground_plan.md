...
- завести живые материалы в `tracks/shad/data analysis` и подключить `lessonPath`;
...
- `lessonPath`: пока не указывать, потому что `tracks/shad/data analysis` пустой.
...
- `tracks/shad/data analysis/README.md` or plan-only entry;
