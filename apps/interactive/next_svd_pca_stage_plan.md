...
- `tracks/shad/algebra/13_Complex_spaces/lesson.md`
...
- `tracks/shad/algebra/10_Bilinear_quadratic_forms/lesson.md`
  - квадратичные формы и diagonalization.
- `tracks/shad/algebra/11_Euclidean_spaces/lesson.md`
  - ортогональность, ортонормированные базисы, ортогональные операторы.
- `tracks/shad/algebra/12_Eigenvectors_eigenvalues/lesson.md`
...
- difficulty: `3`;
- lessonPath: `tracks/shad/algebra/13_Complex_spaces/lesson.md`;
...
```ts
{
  ...
  section: 'algebra',
  lessonPaths: ['tracks/shad/algebra/13_Complex_spaces/lesson.md'],
...
- `make mission-audit`;
- `.venv/bin/python apps/interactive/scripts/smoke_playwright.py --happy-paths-only`;
- `.venv/bin/python apps/interactive/scripts/smoke_playwright.py --screens-only`;
- `git diff --check`.
