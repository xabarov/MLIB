...
- тема: `tracks/shad/algebra/6_Matrices/lesson.md`;
...
- тема: `tracks/shad/algebra/4_Rank/lesson.md`;
...
- добавлена миссия `/algebra/matrices/machine` и ссылка из
  `tracks/shad/algebra/6_Matrices/lesson.md`;
...
- `tracks/shad/algebra/8_Linear_maps/lesson.md`;
- частично `tracks/shad/algebra/4_Rank/lesson.md`;
- частично `tracks/shad/algebra/3_Linear_equations/lesson.md`.
...
- `tracks/shad/algebra/5_Det/lesson.md`.
...
- Считать det live.
- Добавить 4 уровня.
- Добавить связь с `tracks/shad/algebra/5_Det/lesson.md`.
...
- В `tracks/shad/algebra/8_Linear_maps/lesson.md` обновить подпись ссылки: это уже
  миссия, а не просто модель.
- В `tracks/shad/algebra/5_Det/lesson.md` добавить ссылку на determinant forge только
