"""
Генерация иллюстраций для лекций через OpenRouter (image modalities).

Переменные окружения (см. `.env` в корне репозитория):
...
Стиль по умолчанию: суффикс из shared/lecture_visual_generation/lecture_visual_prompt_suffix.txt
(см. shared/lecture_visual_generation/lecture_visual_design_system.md).
"""
...
LECTURE_VISUAL_DIR = PROJECT_ROOT / "shared" / "lecture_visual_generation"
...
DEFAULT_OUT_DIR = PROJECT_ROOT / "_generated" / "lecture_images"
