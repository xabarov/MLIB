...
SHAD_ROOT = PROJECT_ROOT / "tracks" / "shad"
DEFAULT_DOTENV = PROJECT_ROOT / ".env"
DEFAULT_RULES_FILE = PROJECT_ROOT / "shared" / "lecture_qa_authoring_guide.md"
...
SECTION_SPECS: Dict[str, Dict[str, str]] = {
    ...
    "probability": {"folder": "probability_theory", "profile": "probability"},
    "algorithms": {
        "folder": "programming_algorithms_data_structures",
        "profile": "algo-programming",
    },
