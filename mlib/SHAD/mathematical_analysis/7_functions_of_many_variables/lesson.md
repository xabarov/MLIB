...
Практически метод работает так: составляют систему из уравнения
$$
\nabla f(a)=\lambda \nabla g(a)
$$
и самого ограничения
$$
g(a)=0,
$$
после чего находят все кандидаты и отдельно проверяют, где получается минимум, максимум или отсутствие экстремума.
