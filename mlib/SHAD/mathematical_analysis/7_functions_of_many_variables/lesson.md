...
Точка $a$ на множестве $\{x\colon g(x)=0\}$ называется точкой условного экстремума, если в некоторой окрестности среди всех допустимых точек выполняется
$f(x)\ge f(a)$ или $f(x)\le f(a)$.
...
Это даёт систему уравнений на неизвестные координаты точки и множители Лагранжа.
...
На рисунке ограничение задано окружностью, а линия уровня функции касается её в точке экстремума. Именно эта геометрия стоит за системой Лагранжа.
