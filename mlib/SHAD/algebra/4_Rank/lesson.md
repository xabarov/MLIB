...
- разделы 1--4 вводят линейную зависимость, базис и основную лемму;
- разделы 5--6 связывают эти понятия с рангом строк и столбцов;
- разделы 7--8 переводят ранг в язык совместности и единственности СЛАУ;
- разделы 9--12 посвящены однородным системам, ФСР и практическому алгоритму.
