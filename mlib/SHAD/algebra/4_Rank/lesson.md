...
![Декоративная иллюстрация к теме линейной зависимости и ранга](assets/hero_rank_linear_dependence.png)

![Иллюстрация к теме ранга матрицы: выбор базисных строк и столбцов](assets/rank_rows_and_columns.png)
...
![Декоративная иллюстрация: согласованность и несогласованность в критерии Кронекера-Капелли](assets/kronecker_capelli_metaphor.png)
