...
**Свойство.** BFS вычисляет **кратчайший путь** (минимальное число рёбер) от $s$ до каждой достижимой вершины во **невзвешенном** графе.
...
### 5.1 Кратчайший путь во невзвешенном графе
...
**4. В орграфе пропускать родителя как обратное ребро.**
...
2. Почему BFS гарантирует кратчайший путь во невзвешенном графе, а DFS — нет? Приведите пример графа, где DFS найдёт неоптимальный путь.
