...
Эта реализация имеет сложность $O(2^n)$ из-за повторных вычислений. Итеративная версия или динамическое программирование снижают её до $O(n)$.
...
Количество ходов: $T(n) = 2T(n-1) + 1$, откуда $T(n) = 2^n - 1$.
