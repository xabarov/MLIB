...
**Практическое правило.** Поддерживать $\alpha \leq 0{,}75$ (как в Java's HashMap). При превышении — перехеширование: создать таблицу вдвое большего размера и перенести все элементы. Амортизированная стоимость перехеширования — O(1) на операцию.
