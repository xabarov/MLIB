...
**Почему 4n?** При $n$ элементах дерево в худшем случае (когда $n$ не степень двойки) занимает до $4n$ ячеек. Это стандартный «запас с горкой».

**Инварант:** значение в каждом узле равно агрегату (сумме/минимуму/максимуму) соответствующего подотрезка из двух его потомков.
