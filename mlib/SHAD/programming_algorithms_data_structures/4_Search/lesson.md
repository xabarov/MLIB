...
Жадная проверка здесь корректна: если вообще существует разбиение с максимумом $\leq T$, то и «набирать каждому художнику максимум, пока влезает» тоже уложится в $k$ отрезков.
