...
### tracks/ml-interviews — Q&A по книге

Плоские заметки «вопрос → ответ», без структуры лекций. DoD ниже к ним **не применяется**.
Нумерация глав книги сохранена в `tracks/ml-interviews/README.md`.
