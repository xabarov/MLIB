"""
Графики и анимации для лекции tracks/shad/mathematical_analysis/1_limits (пределы последовательностей).

Палитра: shared/lecture_visual_generation/lecture_visual_design_system.md
"""
